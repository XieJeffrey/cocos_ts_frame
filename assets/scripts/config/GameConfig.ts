 ...
 * @LastEditTime: 2021-09-03 10:21:07
...
export default class GameConfig extends IManager {
    ...
    public roleScale: number = 0.4;//曹操缩放比例
    public mineScale: number = 0.2;//士兵的缩放比例
    public enemyScale: number = 0.23;//敌兵的缩放比例
    public neutralScale: number = 0.3;//中立士兵相对其他士兵的缩放比例
